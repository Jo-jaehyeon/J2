...
public static class ArenaBuild
{
    public static void BuildSmoke()
    {
        ...
        var report = BuildPipeline.BuildPlayer(new BuildPlayerOptions {
            ...
            locationPathName = "Builds/DigitalArena/DigitalArena.exe",
            target = BuildTarget.StandaloneWindows64,
            options = BuildOptions.Development
        });
        if (report.summary.result != BuildResult.Succeeded) throw new Exception("3D player build failed: " + report.summary.result);
